...
s = nsy.Variable(name="signal_width", symbol="s", unit=nsy.u.meter)
w = nsy.Variable(name="gap_width", symbol="w", unit=nsy.u.meter)

# Determine the signal to ground separation constant ($k$)
k_0 = nsy.Variable(name="signal_to_ground_constant", symbol="k_0")
